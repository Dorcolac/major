    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-success">
                <div class="panel-heading">Prijavljivanje</div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn-block btn btn-primary btn-lg">
                                    <i class="fa fa-btn fa-sign-in"></i> Prijavi me
                                </button><br>

                                <a class="btn btn-link btn-block" href="{{ url('/password/reset') }}">Zaboravili ste lozinku?</a>

                                <a class="btn btn-default btn-block" href="{{ ('/register') }}">
                                    <i class="fa fa-btn fa-sign-in"></i> Registruj se
                                </a>
                            </div>
                        </div>
                    </form>
